    ...
    <section className="relative flex flex-col items-center justify-center py-12 lg:py-20">
      <div className="text-center">
        <span className="text-sm text-primary font-medium tracking-tight bg-primary/10 px-4 py-2 rounded-full">
          Introducing AlCal 1.0
        </span>
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl mt-8 font-medium leading-none">
          Shedualing made{" "}
          <span className="block text-primary -mt-2">super easy!</span>
        </h1>
        <p className="max-w-xl mx-auto mt-4 lg:text-lg text-muted-foreground">
          Scheduling a meeting can be a pain. But we at AlCal make it easy for
